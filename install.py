...
# the goal is to install this using core python libs with NO external deps
import hashlib
import logging
import os
import re
...
bootstrap_file_with_path=os.path.normpath(f"{ install_dir }/cosign")
...
desired_cosign_filename_with_path=os.path.normpath(f"{ install_dir }/{ desired_cosign_filename }")
